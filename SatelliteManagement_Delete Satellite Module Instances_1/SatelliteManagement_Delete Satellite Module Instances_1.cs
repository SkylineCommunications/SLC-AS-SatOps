...
namespace SatelliteManagement_DOM_Delete_Satellite_Module_Instances_1
{
	using System;
	using System.Linq;
	...
	public class Script
	{
		private const string ScriptName = "SAT-AS-Delete Satellite Module Instances";
		...
		public void Run(IEngine engine)
		{
			using (var logger = new SatOpsLogger(SatOpsLogger.Types.Satellite))
			{
				...
				var instances = domHelper.DomInstances.ReadAllPaged().Flatten();

				try
				{
					domHelper.DomInstances.DeleteInBatches(instances).ThrowOnFailure();
				}
				catch (Exception e)
				{
